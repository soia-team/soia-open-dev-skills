...
## 修复
- fix(dispatch): enforce quota evidence binding at route boundary (#116)
- fix(dispatch): bind quota precheck to the selected bucket, block by quota scope

## 维护
- chore(release): open next train after v2.6.0 (#115)
